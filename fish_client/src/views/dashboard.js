    ...
    return [
      ...
      m('.blurb',
        m('p',
          ...
          'that tracks both Fish provenance and a timestamped history ',
          'detailing how a fish was stored, handled, and transported.'),
        m('p',
          m('em', 'FishNet'),
        ...
        m('p',
          ...
          'Once logged in, you will be able to add new fish to ',
