...
/// The Intkey add transaction family name (intkey_add)
const INTKEY_MULITPLY_FAMILY_NAME: &str = "intkey_add";

/// The Intkey add transaction family version (1.0)
...
/// # Arguments
///
/// * `payload` - a fully populated intkey add payload
